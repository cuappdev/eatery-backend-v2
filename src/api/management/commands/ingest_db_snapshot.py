...
class Command(BaseCommand):
    help = (
        "Overrides current state of the db with a db snapshot. Takes --input argument"
    )
    ...
    def handle(self, *args, **options):
        ...
        self.ingest_data(
            serializers.AlertStoreSerializer, folder_path, SnapshotFileName.ALERT_STORE
        )
        self.ingest_data(
            serializers.MenuStoreSerializer, folder_path, SnapshotFileName.MENU_STORE
        )
        self.ingest_data(
        ...
        self.ingest_data(
            serializers.ItemStoreSerializer, folder_path, SnapshotFileName.ITEM_STORE
        )
        self.ingest_data(
