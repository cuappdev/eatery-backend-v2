...
from dfg.datatype.EateryAlert import EateryAlert
from dfg.datatype.Event import Event
from dfg.datatype.Menu import Menu
from dfg.datatype.MenuCategory import MenuCategory
from dfg.datatype.MenuItem import MenuItem
...
class EateriesFromDB(DfgNode):
    ...
    def eatery_from_serialized(serialized_eatery: dict, serialized_alerts: list[dict]) -> Eatery:
        return Eatery(
            ...
            payment_accepts_meal_swipes=serialized_eatery["payment_accepts_meal_swipes"],
